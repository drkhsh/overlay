...
declare -A GIT_CRATES=(
	...
	[presage-store-sqlite]='https://github.com/whisperfish/presage;d3a760088617b657b41ccd4f43e4629e3c3188ac;presage-%commit%/presage-store-sqlite'
	[presage]='https://github.com/whisperfish/presage;d3a760088617b657b41ccd4f43e4629e3c3188ac;presage-%commit%/presage'
...
LICENSE+="
	AGPL-3 Apache-2.0 BSD-2 BSD Boost-1.0 ISC MIT MPL-2.0 Unicode-3.0
	ZLIB
"
SLOT="0"
KEYWORDS="~amd64"
...
src_prepare() {
	...
	sed -i -e "/^\[patch/,\$s@^\(\"curve25519-dalek\" = \).*@\1 { path = \"${WORKDIR}/curve25519-dalek-${COMMIT}/curve25519-dalek\" }@" Cargo.toml || die
	default
}
